...
public enum FeedSource {
    ...
    FOX_WORLD(
            ...
            ArticleCategory.WORLD, "https://moxie.foxnews.com/google-publisher/world.xml"
    ),
    NYT_WORLD(
            "New York Times", Country.US, PoliticalLeaning.PROGRESSIVE,
            ArticleCategory.WORLD, "https://rss.nytimes.com/services/xml/rss/nyt/World.xml"
    ),
    CHOSUN_WORLD(
            "Chosun Ilbo", Country.KR, PoliticalLeaning.CONSERVATIVE,
            ArticleCategory.WORLD, "https://www.chosun.com/arc/outboundfeeds/rss/category/international/?outputType=xml"
    ),
    HANI_WORLD(
            "Hankyoreh", Country.KR, PoliticalLeaning.PROGRESSIVE,
            ArticleCategory.WORLD, "https://www.hani.co.kr/rss/international"
    );
